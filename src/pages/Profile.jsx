            ...
            <form>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="firstname" class="form-control" placeholder={user.firstName} />
                    </div>
                    <div class="form-group col-md-6">
                        <label for="lastname">Lastname</label>
                        <input type="text" id="lastname" class="form-control" placeholder={user.lastName} />
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail4">Email</label>
                    <input type="email" class="form-control" id="inputEmail4" placeholder={user.username} />
                </div>
                <div class="form-group">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="inputCompany5">Age</label>
                ...
                <button type="submit" class="btn btn-primary submit-btn">Save Change</button>
            </form>
        </div>
    </div>
</div>
