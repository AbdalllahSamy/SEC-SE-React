...
function FormAddSec({ title, stl, onTeacherAdded }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post('/api/admin/secretary', values, {
        headers: {
      ...
      console.error('Failed to add sec:', error);
    }
  };
